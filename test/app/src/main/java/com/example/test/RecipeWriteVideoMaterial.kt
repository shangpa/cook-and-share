...
class RecipeWriteVideoMaterial : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_video_material)
        ...
        // nextFixButton 클릭했을 때 RecipeWriteVideoTitle 이동
    ...
    private fun addNewItem() {
        ...
        val materialSix = EditText(this).apply {
            ...
            layoutParams = ConstraintLayout.LayoutParams(
                ...
                setMargins(dpToPx(18), dpToPx(10), 0, 0) // 위쪽 여백 설정
            }
            hint = "재료명"
            textSize = 13f
