...
class RecipeWriteBothReplaceMaterial : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_both_replace_material)
        ...
        // nextFixButton 클릭했을 때 RecipeWriteBothHandlindMethod 이동
        ...
        // skipFixButton 클릭했을 때 RecipeWriteBothMaterial 이동
        ...
        deleteTwo.setOnClickListener {
            materialTwo.visibility = View.VISIBLE
            measuringTwo.visibility = View.VISIBLE
            deleteTwo.visibility = ImageButton.VISIBLE
            divideRectangleBarFour.visibility = View.VISIBLE
        }
        ...
        private fun addNewItem() {
            ...
            // 계량 EditText 생성
            val measuringTwo = EditText(this).apply {
            ...
            // 삭제 버튼 생성
            val deleteTwo = ImageButton(this).apply {
                id = View.generateViewId()  // ID 생성
                layoutParams = ConstraintLayout.LayoutParams(
                    ConstraintLayout.LayoutParams.WRAP_CONTENT,
                    ConstraintLayout.LayoutParams.WRAP_CONTENT
