...
class RecipeWriteImageDetailSettle : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_image_detail_settle)
        ...
        // skipFixButton 클릭했을 때 RecipeWriteImageCookOrder 이동
