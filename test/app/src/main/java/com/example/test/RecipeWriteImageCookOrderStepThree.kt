...
class RecipeWriteImageCookOrderStepThree : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_image_cook_order_step3)

        // nextFixButton 클릭했을 때 RecipeWriteImageCookOrderStep4 이동
        val nextFixButton: Button = findViewById(R.id.nextFixButton)
        nextFixButton.setOnClickListener {
            val intent = Intent(this, RecipeWriteImageCookOrderStepFour::class.java)
