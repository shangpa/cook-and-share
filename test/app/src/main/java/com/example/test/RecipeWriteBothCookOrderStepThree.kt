...
class RecipeWriteBothCookOrderStepThree : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_both_cook_order_step3)

        // nextFixButton 클릭했을 때 RecipeWriteBothCookOrderStepFour 이동
        val nextFixButton: Button = findViewById(R.id.nextFixButton)
        nextFixButton.setOnClickListener {
            val intent = Intent(this, RecipeWriteBothCookOrderStepFour::class.java)
