...
class RecipeWriteVideoDetailSettle : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_video_detail_settle)

        // nextFixButton 클릭했을 때 RecipeWriteVideoContentCheck 이동
        ...
        // skipFixButton 클릭했을 때 RecipeWriteVideoCookVideo 이동
