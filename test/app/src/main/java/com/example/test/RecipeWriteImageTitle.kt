...
class RecipeWriteImageTitle : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_recipe_write_image_title)

        // nextFixButton 클릭했을 때 RecipeWriteImageMaterial 이동
