...
class MaterialMyProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ic_rigth1: LinearLayout = findViewById(R.id.ic_rigth1)
        ...
        val ic_rigth2: LinearLayout = findViewById(R.id.ic_rigth2)
        ...
        val ic_rigth3: LinearLayout = findViewById(R.id.ic_rigth3)
        ...
        val ic_rigth4: LinearLayout = findViewById(R.id.ic_rigth4)
